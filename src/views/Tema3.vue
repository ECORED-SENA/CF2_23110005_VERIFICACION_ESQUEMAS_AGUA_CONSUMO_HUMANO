...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center(data-aos="fade-left")      
      .col-12.col-lg-5.position-relative.mb-4.mb-md-0
          div.p-5.bgr
    ...
    .row.justify-content-center
        .col-md-2.mb-4.mb-md-0.px-5.px-md-0
          img(src='@/assets/curso/tema3/img02.svg', alt='Texto que describa la imagen')
        .col-lg-10
          p Como concepto, la seguridad y salud en el trabajo es un proceso que abarca todos aquellos aspectos relacionados, como su nombre lo indica, con la seguridad y salud en el campo laboral; <strong>prestando total atención a la prevención de riesgos como accidentes y lesiones que pueden sufrir los empleados por desarrollar actividades dentro o fuera de la organización</strong>, dichas acciones preventivas son responsabilidad del empleador que, a través de los gobiernos, establecen marcos que permiten ofrecer soluciones flexibles al empleador para facilitar sus actividades empresariales con protocolos de seguridad. 
          .row
            .col-lg-7
    ...
    TabsA.color-acento-botones.mb-5
      .tarjeta.bg2.p-4(titulo="Condiciones de seguridad")  
        .row.justify-content-center
          .col-md-4.mb-4
            h3 Condiciones de seguridad
            p Influyen directamente en la accidentabilidad, pueden ser pasillos, aparatos y maquinaria implementada para el proceso laboral, vehículos de transporte dentro de la organización, instalaciones, superficies de tránsito, entre otros.
      ...
      .tarjeta.bg2.p-4(titulo="Riesgos físicos")  
        .row.justify-content-center
          .col-md-4.mb-4
            h3 Riesgos físicos
            p Los cuales se encuentran relacionados con el mismo lugar donde se realizan las actividades laborales y pueden darse por movimientos repetitivos en largas jornadas, desplazamientos muy largos y cargas muy pesadas, entre otros.
          .col-md-4.col-md-7.col-lg-7
            img(src='@/assets/curso/tema3/img07.png')
      .tarjeta.bg2.p-4(titulo="Riesgos psicosociales")  
        .row.justify-content-center
          .col-md-4.mb-4
            h3 Riesgos psicosociales
            p Son aquellos riesgos que se dan por presiones excesivas de trabajo, problemas de entorno y clima organizacional, objetivos sumamente difíciles de alcanzar y entre otros factores que pueden generar ansiedad, insomnio e incluso depresión.
          .col-md-4.col-md-7.col-lg-7
    ...
    .row.mb-0.justify-content-center
      ...
      .col-12.col-md-3.mb-5
        .bg06.alingxy.p-4.tranform
          ...
          h3.p-3 Botas plásticas
      .col-12.col-md-3.mb-5
        .bg06.alingxy.p-4.tranform
          figure.img90
            img(src='@/assets/curso/tema3/img17.svg', alt='')
          h3.p-3 Delantal plástico
